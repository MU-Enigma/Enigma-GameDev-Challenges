...
func get_rook_moves(piece_position : Vector2):
	...
	for direction in directions:
		...
		while is_valid_position(pos): # User-defined function
			if !move_undo_append(4, piece_position, pos, _moves): break # User-defined function
			pos += direction
...
func get_bishop_moves(piece_position : Vector2):
	...
	for direction in directions:
		...
		pos += direction
		while is_valid_position(pos): # User-defined function
			if !move_undo_append(3, piece_position, pos, _moves): break # User-defined function
			pos += direction
...
func get_queen_moves(piece_position : Vector2):
	...
	for direction in directions:
		...
		pos += direction
		while is_valid_position(pos): # User-defined function
			if !move_undo_append(5, piece_position, pos, _moves): break # User-defined function
			pos += direction
...
func get_knight_moves(piece_position : Vector2):
	...
	for direction in directions:
		...
		if is_valid_position(pos): # User-defined function
			move_undo_append(2, piece_position, pos, _moves) # User-defined function
